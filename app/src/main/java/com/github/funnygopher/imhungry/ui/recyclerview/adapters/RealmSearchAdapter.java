...
public abstract class RealmSearchAdapter<T extends RealmObject, VH extends RealmSearchViewHolder>
    ...
    /**
     * Creates a {@link com.github.funnygopher.imhungry.ui.recyclerview.adapters.RealmSearchAdapter} with only the filter columnKey. The defaults are:
     * - useContains: true
     * - casing: insensitive
     * - sortOrder: ascending
     * - sortKey: filterKey
    ...
    /**
     * Creates a {@link com.github.funnygopher.imhungry.ui.recyclerview.adapters.RealmSearchAdapter} with parameters for all options.
     */
